...
<div class="container py-3" x-data="fuaPdfViewer()">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <a href="{{ route('fuas.configuration.edit') }}" class="btn btn-outline-primary"><i class="bi bi-gear me-2"></i>Configurar FUA</a>
    </div>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                @forelse($fuas as $fua)
                    <tr>
                        ...
                        <td>{{ ['HEMODIALYSIS' => 'Hemodiálisis', 'NEPHROLOGY' => 'Consulta nefrológica', 'CORRECTION' => 'Subsanación'][$fua->type] ?? $fua->type }}</td>
