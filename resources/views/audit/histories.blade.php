...
<div class="container-fluid">
    ...
    <div class="card shadow-sm overflow-hidden"><div class="table-responsive"><table class="table table-hover align-middle mb-0">
        <thead class="table-light"><tr><th>Fecha</th><th>Paciente</th><th>Turno</th><th>Orden</th><th>Estado</th><th class="text-end">Corrección</th><th>Módulo</th></tr></thead>
        <tbody>@forelse($orders as $order)<tr>
            ...
            <td>Turno {{ $order->turno }}</td><td>{{ $order->codigo_unico }}</td>
            ...
            </div></td><td class="text-nowrap">{{ $order->sala }}</td>
        </tr>@empty<tr><td colspan="7" class="text-center text-muted py-5">No hay atenciones para los filtros seleccionados.</td></tr>@endforelse</tbody>
