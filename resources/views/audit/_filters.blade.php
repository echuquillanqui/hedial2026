<form method="GET" class="card card-body shadow-sm mb-4">
    <div class="row g-3 align-items-end">
        ...
        <div class="col-lg-auto d-flex gap-2"><button class="btn btn-primary"><i class="bi bi-funnel me-1"></i>Filtrar</button><a class="btn btn-outline-secondary" href="{{ url()->current() }}">Limpiar</a></div>
    </div>
</form>
