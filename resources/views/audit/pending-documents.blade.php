...
<div class="container-fluid py-4 audit-pending">
    ...
    <form method="GET" class="card card-body shadow-sm mb-4" data-audit-filters>
        <div class="row g-3 align-items-end">
            ...
            <div class="col-xl-1 col-md-3"><label class="form-label">Módulo</label><select name="module" class="form-select"><option value="">Todos</option>@foreach(\App\Models\Patient::MODULES as $value)<option value="{{ $value }}" @selected((string)request('module') === (string)$value)>{{ $value }}</option>@endforeach</select></div>
