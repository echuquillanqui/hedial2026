...
<div class="container-fluid py-4 audit-pending">
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
        <div><span class="text-uppercase text-danger fw-bold small">Auditoría clínica</span><h2 class="fw-bold mb-1">Documentos pendientes</h2><p class="text-muted mb-0">Pacientes con documentos que aún no se generaron en la fecha seleccionada.</p></div>
