...
document.addEventListener('DOMContentLoaded', () => {
    ...
    medicationResults.addEventListener('click',e=>{const option=e.target.closest('.medication-option');if(!option||!activeMedicationInput)return;const row=activeMedicationInput.closest('.medication-row');row.querySelector('.medication-code').value=option.dataset.code;row.querySelector('.medication-name').value=option.dataset.name;row.querySelector('.prescribed-quantity').value=option.dataset.quantity;row.querySelector('.delivered-quantity').value=option.dataset.quantity;closeMedicationResults();});
