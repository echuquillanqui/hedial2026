    ...
    <div class="card shadow-sm">
        ...
        <div class="table-responsive"><table class="table table-hover align-middle mb-0">
            ...
            <tbody>@forelse($consultations as $item)<tr>
                ...
                <td class="text-end"><a href="{{ route('consultations.edit', $item) }}" class="btn btn-sm btn-outline-primary">Rellenar / editar</a> <a target="_blank" href="{{ route('consultations.pdf', $item) }}" class="btn btn-sm btn-outline-danger"><i class="bi bi-file-earmark-pdf"></i> Consulta PDF</a> @if($item->order?->fua)<a target="_blank" href="{{ route('fuas.pdf', $item->order->fua) }}" class="btn btn-sm btn-outline-danger"><i class="bi bi-file-earmark-pdf"></i> FUA</a> @endif<a target="_blank" href="{{ route('consultations.prescription.pdf', $item) }}" class="btn btn-sm btn-danger"><i class="bi bi-file-earmark-pdf"></i> Receta</a></td>
