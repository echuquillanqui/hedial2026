...
<div class="container-fluid px-4 py-4">
    ...
    <form method="GET" class="card card-body shadow-sm border-0 mb-4">
        ...
        <div class="row g-2 align-items-end">
            ...
            <div class="col-lg-1 col-md-4"><label class="filter-label">Módulo</label><select class="form-select form-select-sm border-success" name="modulo"><option value="">Todos</option>@foreach(\App\Models\Patient::MODULES as $modulo)<option value="{{ $modulo }}" @selected((string)request('modulo')===(string)$modulo)>{{ $modulo === \App\Models\Patient::ISOLATED_MODULE ? 'AISLADO' : 'M'.$modulo }}</option>@endforeach</select></div>
